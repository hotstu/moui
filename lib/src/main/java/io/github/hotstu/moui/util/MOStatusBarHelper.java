 ...
 * @date 2016-03-27
 */
public class MOStatusBarHelper {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        return MODeviceHelper.isMIUIV5() || MODeviceHelper.isMIUIV6() ||
                MODeviceHelper.isMIUIV7() || MODeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(MODeviceHelper.isZUKZ1() || MODeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (MODeviceHelper.isTablet(context)
                && sStatusbarHeight > MODisplayHelper.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            //状态栏高度大于25dp的平板，状态栏通常在下方
            sStatusbarHeight = 0;
        } else {
            if (sStatusbarHeight <= 0
                    || sStatusbarHeight > MODisplayHelper.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP * 2)) {
