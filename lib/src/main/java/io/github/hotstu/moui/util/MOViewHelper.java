package io.github.hotstu.moui.util;
...
public class MOViewHelper {
    ...
    public static void playViewBackgroundAnimation(final View v, @ColorInt int startColor, @ColorInt int endColor, long duration, int repeatCount, int setAnimTagId, final Runnable endAction) {
        ...
        MOViewHelper.setBackgroundColorKeepPadding(v, startColor);
        ...
        anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                MOViewHelper.setBackgroundColorKeepPadding(v, (Integer) animation.getAnimatedValue());
            }
        });
        if (setAnimTagId != 0) {
     ...
     * <p>相关方法 {@link #slideOut(View, int, Animation.AnimationListener, boolean, MODirection)}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideIn(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, MODirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
     ...
     * <p>相关方法 {@link #slideIn(View, int, Animation.AnimationListener, boolean, MODirection)}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideOut(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, MODirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
     ...
     * if (MOViewHelper.getISLastLineSpacingExtraError()) {
