 ...
 * @date 2015-08-25
 */
public class MOObservableScrollView extends ScrollView {

    private List<OnScrollChangedListener> mOnScrollChangedListeners;

    public MOObservableScrollView(Context context) {
        super(context);
    }

    public MOObservableScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MOObservableScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnScrollChangedListener {
        void onScrollChanged(MOObservableScrollView scrollView, int l, int t, int oldl, int oldt);
    }
