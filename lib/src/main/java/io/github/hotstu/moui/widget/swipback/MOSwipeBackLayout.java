package io.github.hotstu.moui.widget.swipback;
...
import io.github.hotstu.moui.widget.MOInsetFrameLayout;
...
public class MOSwipeBackLayout extends MOInsetFrameLayout {
    /**
    ...
    public MOSwipeBackLayout(Context context) {
        this(context, null);
    }

    public MOSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.MOSwipeBackLayoutStyle);
    }

    public MOSwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
    ...
    public static MOSwipeBackLayout wrap(View child, int edgeFlag) {
        MOSwipeBackLayout wrapper = new MOSwipeBackLayout(child.getContext());
